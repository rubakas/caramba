...
- The Jellyfin engine is vendored at `server/vendor/jellyfin-rails/`. Treat it as a dependency: bug fixes can be edited in place, but new features belong upstream first.
