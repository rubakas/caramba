...
#   6. Directory exists: sudo mkdir -p /opt/caramba && sudo chown $(whoami) /opt/caramba
#   7. master.key copied: mkdir -p /opt/caramba/shared/server/config && cp config/master.key /opt/caramba/shared/server/config/master.key
